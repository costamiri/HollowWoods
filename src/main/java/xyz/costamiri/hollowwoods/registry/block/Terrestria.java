...
public class Terrestria extends HollowBlocks {
    ...
    public void registerBlocks() {
        ...
        new HollowBlocks.LogCreator()
                .raw(HOLLOW_HEMLOCK_LOG, Identifier.of(this.namespace, "hemlock_log"))
                .stripped(STRIPPED_HOLLOW_HEMLOCK_LOG, Identifier.of(this.namespace, "stripped_hemlock_log"))
        ...
        new HollowBlocks.LogCreator()
                .raw(HOLLOW_JAPANESE_MAPLE_LOG, Identifier.of(this.namespace, "japanese_maple_log"))
                .stripped(STRIPPED_HOLLOW_JAPANESE_MAPLE_LOG, Identifier.of(this.namespace, "stripped_japanese_maple_log"))
        ...
        new HollowBlocks.LogCreator()
                .raw(HOLLOW_RUBBER_LOG, Identifier.of(this.namespace, "rubber_log"))
                .stripped(STRIPPED_HOLLOW_RUBBER_LOG, Identifier.of(this.namespace, "stripped_rubber_log"))
