...
public class Byg extends HollowBlocks {
    ...
    public void addBlocksStripping() {
        addStrippedBlock(HOLLOW_ASPEN_LOG, STRIPPED_HOLLOW_ASPEN_LOG);
        addStrippedBlock(HOLLOW_BAOBAB_LOG, STRIPPED_HOLLOW_BAOBAB_LOG);
        addStrippedBlock(HOLLOW_BLUE_ENCHANTED_LOG, STRIPPED_HOLLOW_BLUE_ENCHANTED_LOG);
        addStrippedBlock(HOLLOW_CHERRY_LOG, STRIPPED_HOLLOW_CHERRY_LOG);
        addStrippedBlock(HOLLOW_CIKA_LOG, STRIPPED_HOLLOW_CIKA_LOG);
        addStrippedBlock(HOLLOW_CYPRESS_LOG, STRIPPED_HOLLOW_CYPRESS_LOG);
        addStrippedBlock(HOLLOW_EBONY_LOG, STRIPPED_HOLLOW_EBONY_LOG);
        addStrippedBlock(HOLLOW_ETHER_LOG, STRIPPED_HOLLOW_ETHER_LOG);
        addStrippedBlock(HOLLOW_FIR_LOG, STRIPPED_HOLLOW_FIR_LOG);
        addStrippedBlock(HOLLOW_GREEN_ENCHANTED_LOG, STRIPPED_HOLLOW_GREEN_ENCHANTED_LOG);
        addStrippedBlock(HOLLOW_HOLLY_LOG, STRIPPED_HOLLOW_HOLLY_LOG);
        addStrippedBlock(HOLLOW_JACARANDA_LOG, STRIPPED_HOLLOW_JACARANDA_LOG);
        addStrippedBlock(HOLLOW_LAMENT_LOG, STRIPPED_HOLLOW_LAMENT_LOG);
        addStrippedBlock(HOLLOW_MAHOGANY_LOG, STRIPPED_HOLLOW_MAHOGANY_LOG);
        addStrippedBlock(HOLLOW_MANGROVE_LOG, STRIPPED_HOLLOW_MANGROVE_LOG);
        addStrippedBlock(HOLLOW_MAPLE_LOG, STRIPPED_HOLLOW_MAPLE_LOG);
        addStrippedBlock(HOLLOW_NIGHTSHADE_LOG, STRIPPED_HOLLOW_NIGHTSHADE_LOG);
        addStrippedBlock(HOLLOW_PALM_LOG, STRIPPED_HOLLOW_PALM_LOG);
        addStrippedBlock(HOLLOW_PALO_VERDE_LOG, STRIPPED_HOLLOW_PALO_VERDE_LOG);
        addStrippedBlock(HOLLOW_PINE_LOG, STRIPPED_HOLLOW_PINE_LOG);
